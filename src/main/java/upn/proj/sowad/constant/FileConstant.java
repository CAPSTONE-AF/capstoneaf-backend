...
public class FileConstant {
    ...
    public static final String TEMA_IMAGE_PATH = "/tema/image/";
    public static final String JPG_EXTENSION = "jpg";
    public static final String USER_FOLDER = System.getProperty("user.home") + "/sowad-backend/user/";
    public static final String TEMA_FOLDER = System.getProperty("user.home") + "/sowad-backend/tema/";
    public static final String DIRECTORY_CREATED = "Created directory for: ";
    public static final String DEFAULT_USER_IMAGE_PATH = "/user/image/profile/";
    public static final String DEFAULT_TEMA_IMAGE_PATH = "/tema/image/portada/";
